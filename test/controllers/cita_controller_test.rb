...
class CitaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post cita_url, params: { citum: { asunto: @citum.asunto, doctor: @citum.doctor, estado: @citum.estado, fecha: @citum.fecha, user_id: @citum.user_id } }
    end
  ...
  test "should update citum" do
    patch citum_url(@citum), params: { citum: { asunto: @citum.asunto, doctor: @citum.doctor, estado: @citum.estado, fecha: @citum.fecha, user_id: @citum.user_id } }
